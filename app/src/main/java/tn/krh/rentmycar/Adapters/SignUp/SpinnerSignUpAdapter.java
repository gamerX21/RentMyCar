package tn.krh.rentmycar.Adapters.SignUp;
...
public class SpinnerSignUpAdapter extends ArrayAdapter<SpinnerItem> {
    int groupid;
    Activity context;
    ArrayList<SpinnerItem> list;
    LayoutInflater inflater;
    public SpinnerSignUpAdapter(Activity context, int groupid, int id, ArrayList<SpinnerItem> list){
